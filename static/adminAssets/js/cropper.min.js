     ...
     var Rt = {
               ...
               renderCanvas: function (t, e) {
                    ...
                    e &&
                         ...
                         (n.oldLeft = n.left),
                         (n.oldTop = n.top),
                         lt(this.canvas, rt({ width: n.width, height: n.height }, Ht({ translateX: n.left, translateY: n.top }))),
                         this.renderImage(t),
               ...
               renderCropBox: function () {
                    ...
                    (i.width > i.maxWidth || i.width < i.minWidth) && (i.left = i.oldLeft),
                         ...
                         (i.oldLeft = i.left),
                         (i.oldTop = i.top),
                         t.movable && t.cropBoxMovable && wt(this.face, g, i.width >= e.width && i.height >= e.height ? E : k),
                         lt(
                              this.cropBox,
                         ...
                         ht(this.previews, function (t) {
                              ...
                              r && (o = s * (e = i / r)),
                                   ...
                                   lt(
                                        ...
                                        rt({ width: c * e, height: d * e }, Ht(rt({ translateX: -l * e, translateY: -p * e }, h)))
                                   );
                         }));
               },
          },
               ...
               cropEnd: function (t) {
                    ...
                    this.disabled ||
                         ...
                         e &&
                              ...
                              this.cropping && ((this.cropping = !1), ut(this.dragBox, m, this.cropped && this.options.modal)),
          ...
          At = {
               ...
               destroy: function () {
                    var t = this.element;
                    return (
                         t[c] && ((t[c] = void 0), this.isImg && this.replaced && (t.src = this.originalUrl), this.uncreate()),
                         this
                    );
               },
               move: function (t) {
